...
use Meiji\YandexMetrikaOffline\ValueObject\ConversionFile;
...
class Upload
{
    ...
    public function send()
    {
        ...
        $response = $this->conversionInstance->getHTTPClient()
            ->setUrl($requestUrl)
            ->addFile($this->getConversionFile())
            ->requestPost();
    ...
    public function getConversionFile()
    {
        return new ConversionFile($this->header, $this->conversions);
    }
